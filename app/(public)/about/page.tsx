...
const statistics = [
  ...
  { id: 4, icon: Award, number: '12+', title: 'Awards Won' },
];
    ...
    <main className='bg-[#111111] text-white'>
      ...
      <section className='bg-[#111111] py-24'>
        <div className='mx-auto grid max-w-7xl gap-16 px-6 lg:grid-cols-2'>
          ...
          >
            ...
            <motion.p variants={fadeInUp} className='body-font mt-6 leading-8 text-gray-400'>
            ...
            <motion.p variants={fadeInUp} className='body-font mt-5 leading-8 text-gray-400'>
          ...
          >
            {features.map((feature) => (
              ...
              >
                ...
                <h3 className='heading-font text-xl font-bold text-white'>{feature.title}</h3>
                <p className='body-font mt-4 flex-grow text-base leading-7 text-gray-400'>{feature.description}</p>
              </motion.div>
            ))}
          </motion.div>
            ...
            {chefs.map((chef) => (
              ...
              >
                ...
                <div className='flex flex-col p-8'>
                  <h3 className='heading-font text-2xl font-bold text-white'>{chef.name}</h3>
                  <p className='body-font mt-2 font-semibold' style={{ color: 'var(--color-primary)' }}>
                    {chef.role}
                  </p>
                  <p className='body-font mt-5 leading-7 text-gray-400'>{chef.bio}</p>
                </div>
              </motion.div>
            ))}
          </motion.div>
            ...
            {statistics.map((stat) => {
              ...
              return (
                ...
                >
                  ...
                  <p className='body-font mt-3 text-gray-400'>{stat.title}</p>
                </motion.div>
              );
            })}
          </motion.div>
            ...
            {awards.map((award) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className='heading-font mt-3 text-2xl font-bold text-white'>{award.title}</h3>
                  <p className='body-font mt-4 leading-7 text-gray-400'>{award.description}</p>
                </motion.div>
              );
            })}
          </motion.div>
      ...
      >
        ...
        >
          ...
          <motion.p
            variants={fadeInUp}
            className='body-font mt-6 max-w-3xl px-2 text-base leading-8 text-gray-400 sm:text-lg'
          >
            Whether you're planning a family dinner, a celebration, or a casual meal,
            our team is ready to welcome you with authentic flavors and warm hospitality.
          </motion.p>
