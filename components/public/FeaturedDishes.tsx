    ...
    <section className='bg-[#0d0d0d] py-24'>
      <div className='mx-auto max-w-7xl px-6'>
        ...
        <div className='mb-16 text-center'>
          <p className='body-font mb-3 text-sm font-semibold uppercase tracking-[0.35em] text-orange-400'>
            Featured Dishes
          </p>
          <h2 className='heading-font text-3xl font-bold text-white sm:text-4xl lg:text-5xl'>
            Taste our most beloved Nepalese dishes.
          </h2>
          <p className='body-font mx-auto mt-4 max-w-2xl px-2 text-base leading-7 text-gray-400 sm:text-lg'>
            Discover our chef's carefully selected signature dishes, prepared with fresh ingredients and authentic Nepali flavors.
          </p>
        </div>
              ...
              <div className='flex h-full flex-col space-y-4 p-5 sm:p-6'>
                ...
                <div className='mt-auto space-y-4'>
                  ...
                  <div
                    ...
                    className='body-font block w-full rounded-full py-3 text-center font-semibold text-white transition-all duration-300 hover:shadow-lg hover:scale-105 hover:bg-orange-600 active:scale-95 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 sm:py-3.5'
                  >
                    View Details
                  </div>
